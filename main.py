...
def main_l():
    ...
    def ghb():
        try:
            webbrowser.open("https://github.com/gajanan0210")
    ...
    Button(t, text="By Gajanan M",  font=('Comic sans MS',13) , command=ghb, background="grey",foreground="white", activebackground="white", activeforeground="black").place(x=10,y=230)
    p1.place(x=15,y=80)
    p2.place_forget()
    p3.place(x=15,y=170)
    t.mainloop()
